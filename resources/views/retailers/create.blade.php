...
<div class="container" style="margin-bottom: 20px; margin-top: 50px;">
    ...
    <div class="columns" style="margin-left: 500px;">
        <form method="POST" action="{{ route('store-retailer') }}" enctype="multipart/form-data">
            @csrf
            <div class="column">
                <div class="field">
                ...
                <div class="field">
                    <p class="control has-icons-left has-icons-right">
                        <input class="input" type="text" placeholder="website" name="website" required autofocus>
                        <span class="icon is-small is-left">
                            <i class="fas fa-plus"></i>
                        </span>
